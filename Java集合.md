- [概念](#概念)
  - [数组与集合区别，用过哪些？](#数组与集合区别用过哪些)
  - [说说Java中的集合？](#说说java中的集合)
  - [Java中的线程安全的集合是什么？](#java中的线程安全的集合是什么)
  - [Collections和Collection的区别](#collections和collection的区别)
  - [集合遍历的方法有哪些？](#集合遍历的方法有哪些)
- [List](#list)
  - [list可以一边遍历一边修改元素吗？](#list可以一边遍历一边修改元素吗)
  - [list如何快速删除某个指定下标的元素？](#list如何快速删除某个指定下标的元素)
  - [Arraylist和Vector 区别是什么？](#arraylist和vector-区别是什么)
  - [把ArrayList变成线程安全有哪些方法？](#把arraylist变成线程安全有哪些方法)
  - [为什么ArrayList不是线程安全的，具体来说是哪里不安全？](#为什么arraylist不是线程安全的具体来说是哪里不安全)
  - [ArrayList 和 LinkedList 的应用场景？](#arraylist-和-linkedlist-的应用场景)
  - [ArrayList的扩容机制说一下](#arraylist的扩容机制说一下)
  - [线程安全的CopyonWriteArraylist是如何实现线程安全的](#线程安全的copyonwritearraylist是如何实现线程安全的)
  - [List\<\>里面填基本数据类型为什么会报错？](#list里面填基本数据类型为什么会报错)
  - [List和数组如何互相转换？](#list和数组如何互相转换)
- [Set](#set)
  - [Java 集合中 List 和 Set区别是什么？](#java-集合中-list-和-set区别是什么)
  - [如何对Set排序？](#如何对set排序)
- [Map](#map)
  - [如何对map进行快速遍历？](#如何对map进行快速遍历)
  - [HashMap实现原理介绍一下？](#hashmap实现原理介绍一下)
  - [HashMap链表发生转换后为什么不用平衡二叉树？](#hashmap链表发生转换后为什么不用平衡二叉树)
  - [了解的哈希冲突解决方法有哪些？](#了解的哈希冲突解决方法有哪些)
  - [HashMap是线程安全的吗？](#hashmap是线程安全的吗)
  - [在 Java 的 HashMap 中 get一个元素的过程是怎样的？](#在-java-的-hashmap-中-get一个元素的过程是怎样的)
  - [HashMap 的put过程介绍一下](#hashmap-的put过程介绍一下)
  - [为什么是“链表 \> 8”？](#为什么是链表--8)
  - [为什么退化阈值是 6？（防止抖动）](#为什么退化阈值是-6防止抖动)
  - [HashMap 调用get方法一定安全吗？](#hashmap-调用get方法一定安全吗)
  - [HashMap一般用什么做Key？为啥String适合做Key呢？](#hashmap一般用什么做key为啥string适合做key呢)
  - [HashMap的key可以为null吗？](#hashmap的key可以为null吗)
  - [重写HashMap的equal和hashcode方法需要注意什么？](#重写hashmap的equal和hashcode方法需要注意什么)
  - [HashMap的扩容机制介绍一下](#hashmap的扩容机制介绍一下)
  - [说说hashmap的负载因子为什么是0.75](#说说hashmap的负载因子为什么是075)
  - [Hashmap和Hashtable有什么不一样的？](#hashmap和hashtable有什么不一样的)
  - [ConcurrentHashMap怎么实现的？](#concurrenthashmap怎么实现的)
  - [已经用了synchronized，为什么还要用CAS呢？](#已经用了synchronized为什么还要用cas呢)
  - [HashTable 底层实现原理是什么？](#hashtable-底层实现原理是什么)
  - [HashTable线程安全是怎么实现的？](#hashtable线程安全是怎么实现的)
  - [说一下HashMap和Hashtable、ConcurrentMap的区别](#说一下hashmap和hashtableconcurrentmap的区别)
- [Set](#set-1)
  - [Set集合有什么特点？如何实现key无重复的？](#set集合有什么特点如何实现key无重复的)
  - [有序的Set是什么？记录插入顺序的集合是什么？](#有序的set是什么记录插入顺序的集合是什么)
