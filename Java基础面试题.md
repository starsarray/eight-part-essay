- [概念](#概念)
  - [Java的特点：](#java的特点)
  - [Java 的优势和劣势是什么？](#java-的优势和劣势是什么)
  - [JVM、JRE、JDK三者关系？](#jvmjrejdk三者关系)
  - [为什么Java解释和编译都有？](#为什么java解释和编译都有)
  - [Python和Java区别是什么？](#python和java区别是什么)
  - [值传递和引用传递的区别？](#值传递和引用传递的区别)
- [数据类型](#数据类型)
  - [数据类型的转换方式有哪些？](#数据类型的转换方式有哪些)
  - [类型互转会出现什么问题吗？](#类型互转会出现什么问题吗)
  - [为什么用bigDecimal 不用double ？](#为什么用bigdecimal-不用double-)
  - [装箱和拆箱是什么？](#装箱和拆箱是什么)
  - [自动装箱的弊端](#自动装箱的弊端)
  - [Java为什么要有Integer（对象封装）？](#java为什么要有integer对象封装)
  - [说说Integer与int的优缺点](#说说integer与int的优缺点)
  - [说一下 Integer的缓存](#说一下-integer的缓存)
- [面向对象](#面向对象)
  - [怎么理解面向对象？简单说说封装继承多态](#怎么理解面向对象简单说说封装继承多态)
  - [多态体现在哪几个方面？](#多态体现在哪几个方面)
  - [多态解决了什么问题？](#多态解决了什么问题)
  - [面向对象的设计原则你知道有哪些吗](#面向对象的设计原则你知道有哪些吗)
  - [重载与重写有什么区别？](#重载与重写有什么区别)
  - [抽象类和普通类区别？](#抽象类和普通类区别)
  - [Java抽象类和接口的区别是什么？](#java抽象类和接口的区别是什么)
  - [抽象类能加final修饰吗？](#抽象类能加final修饰吗)
  - [接口里面可以定义哪些方法？](#接口里面可以定义哪些方法)
  - [抽象类可以被实例化吗？](#抽象类可以被实例化吗)
  - [接口可以包含构造函数吗？](#接口可以包含构造函数吗)
  - [解释Java中的静态变量和静态方法](#解释java中的静态变量和静态方法)
  - [非静态内部类和静态内部类的区别？](#非静态内部类和静态内部类的区别)
  - [非静态内部类可以直接访问外部方法，编译器是怎么做到的？](#非静态内部类可以直接访问外部方法编译器是怎么做到的)
- [关键字](#关键字)
  - [Java 中 final 作用是什么？](#java-中-final-作用是什么)
  - [Java 中 static的作用是什么？](#java-中-static的作用是什么)
- [深拷贝和浅拷贝](#深拷贝和浅拷贝)
  - [深拷贝和浅拷贝的区别？](#深拷贝和浅拷贝的区别)
  - [实现深拷贝的三种方法是什么？](#实现深拷贝的三种方法是什么)
- [泛型](#泛型)
  - [什么是泛型？](#什么是泛型)
- [对象](#对象)
  - [java创建对象有哪些方式？](#java创建对象有哪些方式)
  - [New出的对象什么时候回收？](#new出的对象什么时候回收)
  - [如何获取私有对象？](#如何获取私有对象)
- [反射](#反射)
  - [什么是反射？](#什么是反射)
  - [反射在你平时写代码或者框架中的应用场景有哪些?](#反射在你平时写代码或者框架中的应用场景有哪些)
- [注解](#注解)
  - [能讲一讲Java注解的原理吗？](#能讲一讲java注解的原理吗)
  - [对注解解析的底层实现了解吗？](#对注解解析的底层实现了解吗)
  - [Java注解的作用域呢？](#java注解的作用域呢)
- [异常](#异常)
  - [介绍一下Java异常](#介绍一下java异常)
  - [Java异常处理有哪些？](#java异常处理有哪些)
  - [抛出异常为什么不用throws？](#抛出异常为什么不用throws)
  - [try{return “a”} finally{return “b”}这条语句返回啥](#tryreturn-a-finallyreturn-b这条语句返回啥)
- [object](#object)
  - [**Object类有哪些方法？**](#object类有哪些方法)
  - [== 与 equals 有什么区别？](#-与-equals-有什么区别)
  - [hashcode和equals方法有什么关系？](#hashcode和equals方法有什么关系)
  - [java 里 string的常用方法有哪些？](#java-里-string的常用方法有哪些)
  - [String、StringBuffer、StringBuilder的区别和联系](#stringstringbufferstringbuilder的区别和联系)
- [Java 新特性](#java-新特性)
  - [Java 8 你知道有什么新特性？](#java-8-你知道有什么新特性)
  - [Lambda 表达式了解吗？](#lambda-表达式了解吗)
  - [Java中stream的API介绍一下](#java中stream的api介绍一下)
  - [Stream流的并行API是什么？](#stream流的并行api是什么)
  - [completableFuture怎么用的？](#completablefuture怎么用的)
  - [Java 21 新特性知道哪些？](#java-21-新特性知道哪些)
- [序列化](#序列化)
  - [怎么把一个对象从一个jvm转移到另一个jvm?](#怎么把一个对象从一个jvm转移到另一个jvm)
  - [序列化和反序列化让你自己实现你会怎么做?](#序列化和反序列化让你自己实现你会怎么做)
  - [将对象转为二进制字节流具体怎么实现?](#将对象转为二进制字节流具体怎么实现)
- [设计模式](#设计模式)
  - [volatile和sychronized如何实现单例模式](#volatile和sychronized如何实现单例模式)
  - [代理模式和适配器模式有什么区别？](#代理模式和适配器模式有什么区别)
  - [责任链模式使用场景是什么？](#责任链模式使用场景是什么)
  - [介绍一下策略模式和责任链模式，分别用在哪些场景？](#介绍一下策略模式和责任链模式分别用在哪些场景)
- [I/O](#io)
  - [**Java怎么实现网络IO高并发编程？**](#java怎么实现网络io高并发编程)
  - [BIO、NIO、AIO区别是什么？](#bionioaio区别是什么)
  - [NIO是怎么实现的？](#nio是怎么实现的)
  - [你知道有哪个框架用到NIO了吗？](#你知道有哪个框架用到nio了吗)
- [其他](#其他)
  - [有一个学生类，想按照分数排序，再按学号排序，应该怎么做？](#有一个学生类想按照分数排序再按学号排序应该怎么做)
  - [Native方法解释一下](#native方法解释一下)
  - [Java 进程是怎么跟操作系统交互的？](#java-进程是怎么跟操作系统交互的)
